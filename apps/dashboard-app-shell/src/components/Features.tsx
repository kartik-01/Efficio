...
const features = [
  ...
  },
  {
    ...
    title: "Time Tracker",
    description: "Monitor time spent on tasks with precise tracking, automatic categorization, and detailed time logs.",
      ...
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-[672px] mx-auto leading-7">
            Each micro-frontend is designed to work independently while seamlessly integrating with others for a complete productivity solution.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-16 h-16 ${feature.iconBg} rounded-2xl flex items-center justify-center mb-8`}>
                {feature.icon}
              </div>
              ...
              <ul className="space-y-2 w-full">
                {feature.items.map((item, itemIndex) => (
                  <li key={itemIndex} className="flex items-start gap-2 text-left">
                    <Check className={`w-3.5 h-3.5 ${feature.checkColor} mt-0.5 flex-shrink-0`} />
