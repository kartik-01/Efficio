...
// Token getter function type - will be set by initializeGroupApi
let getAccessToken: (() => Promise<string | undefined>) | null = null;
let isInitialized = false;

// Initialize groupApi with Auth0 token getter
export const initializeGroupApi = (tokenGetter: () => Promise<string | undefined>) => {
  getAccessToken = tokenGetter;
  isInitialized = true;
};

// Check if groupApi is ready
export const isGroupApiReady = () => isInitialized && getAccessToken !== null;
